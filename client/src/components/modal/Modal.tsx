      ...
      <ModalWrapper $closeModal={modalContext.isModalOpen}>
        <ModalStyled $closeModal={modalContext.isModalOpen}>
          ...
          <ModalItemDescription>
            ...
            <ItemTitle>Tacos de Birria</ItemTitle>
            <ItemPrice>$2.99</ItemPrice>
            <ItemDescription>
              Mollit veniam nulla nulla minim qui. Culpa cupidatat nostrud magna
              proident qui officia laboris elit. Culpa cupidatat nostrud
            </ItemDescription>
          </ModalItemDescription>
          <ModalCloseButtonWrapper>
            <ModalCloseButton onClick={() => modalContext.closeOpenModal()}>
              <span>Close</span>
            </ModalCloseButton>
          </ModalCloseButtonWrapper>
        </ModalStyled>
